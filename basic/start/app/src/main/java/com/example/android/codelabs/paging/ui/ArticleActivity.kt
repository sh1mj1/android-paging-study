    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                articleAdapter.loadStateFlow.collect { combineLoadStates: CombinedLoadStates ->
                    binding.prependProgress.isVisible =
                        combineLoadStates.source.prepend is LoadState.Loading
                    binding.appendProgress.isVisible =
                        combineLoadStates.source.append is LoadState.Loading
                }
            }
        }
